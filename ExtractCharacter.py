...
parser.add_argument('--shade_overlap', action=argparse.BooleanOptionalAction)
...
# Shade out overlap on each individual output image
shade_overlap = args.shade_overlap
